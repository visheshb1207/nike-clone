...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Vishesh Bairwa</Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        ...
                        link={"https://visheshbairwa.netlify.app/"}
                    />
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/visheshb1207/"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/vishesh1207/"}
                    />
                </Flex>
